...
window.Curtain = function Curtain(dir, options) {
  ...
  iframes.forEach(iframe => {
    ...
    if (!(window.Curtain.module[new URL(iframe.src).hostname]) || false) {
      ...
      curtainModule.src = dir + slash + 'modules/' + new URL(iframe.src).hostname + '.js';
